    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Edit <?php echo item('vcategory',$id,'catname');?> </h1>
            </div>
                ...
                <form class="editcategory">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" name="id" id="exampleInputEmail1" placeholder="Name of category" value="Edit <?php echo item('vcategory',$id,'id');?> ">
                    </div>
